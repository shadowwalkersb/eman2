...
//		void rotate_translate(const Transform3D & t);
		 ...
		 * @param x0 starting point x coordinate.
		 * @param dx step of x.
		 * @param inten 0 -> amp, 1-> inten (amp^2), 2->min, 3-> max, 4-> sigma or rmsd intensity from zero if complex, 5-> for 1/2 images along x in real space, origin at x=0, mean amplitude
