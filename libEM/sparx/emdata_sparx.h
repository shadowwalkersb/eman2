 ...
 * @param mult
 */
void onelinenn_ctfw(int j, int n, int n2, EMData* w, EMData* bi, EMData* c2, vector<float> bckgnoise, const Transform& tf, float weight);
 ...
 * @param mult
 */
void onelinetr_ctfw(int j, int bign, int n, int n2, int npad, EMData* w, EMData* bi, EMData* c2, vector<float> bckgnoise, const Transform& tf, float weight);
 ...
 * @param mult
 */
void nn_ctfw(EMData* w, EMData* myfft, EMData* ctf2d2, int npad, vector<float> bckgnoise, const Transform& tf, float weight);
...
EMData* extract_section2(const Transform& tf, int interpolate_method);
EMData* extract_rings(const Transform& tf, int interpolate_method, int ring_length, int nb, int ne);
...
*/
EMData* FourTruncate(int nxni, int nyn = 1, int nzn = 1, bool RetReal = true, bool normalize = true);
