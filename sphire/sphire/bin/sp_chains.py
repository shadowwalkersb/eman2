...
"""
	...
	if options.dd:
		...
		from ..libpy.sp_utilities import model_circle
		...
		from ..libpy.sp_utilities import get_params2D, model_circle
		from ..libpy.sp_fundamentals import rot_shift2D
		from ..libpy.sp_statistics import ccc
		from time import time
		from ..libpy.sp_alignment import align2d, align2d_scf
		...
		lend = len(d)
		lccc = [None]*( old_div(lend*(lend-1),2) )
		from ..libpy.sp_utilities import read_text_row
		...
		from ..libpy.sp_statistics import ccc
		from time import time
		from ..libpy.sp_alignment import align2d
