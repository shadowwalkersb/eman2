...
class Test_pixel_error_2D(unittest.TestCase):
    ...
    def test_pickle_file(self):
        return_new = fu.pixel_error_2D(
            ali_params1=self.ali_params1, ali_params2=self.ali_params2, r=self.r
        )
        return_old = oldfu.pixel_error_2D(
            ali_params1=self.ali_params1, ali_params2=self.ali_params2, r=self.r
        )
        self.assertEqual(return_new, return_old)
    ...
    def test_r_is0(self):
        return_new = fu.pixel_error_2D(
            ali_params1=self.ali_params1, ali_params2=self.ali_params2, r=0
        )
        return_old = oldfu.pixel_error_2D(
            ali_params1=self.ali_params1, ali_params2=self.ali_params2, r=0
        )
...
class Test_angle_ave(unittest.TestCase):
    ...
    def test_pickle_value(self):
        ...
        self.assertTrue(numpy_array_equal(return_new, return_old))
        self.assertTrue(
            numpy_array_equal(return_new, (348.04583441529024, 4.4154015011463477))
        )
...
class Test_angle_diff_sym(unittest.TestCase):
    angle1 = [
        [5.16760248821511, 102.82730387712962, 56.24999974223351, -0.0, -0.0],
        [5.394529010967219, 108.65382266507675, 57.65624899025124, -0.0, -0.0],
        [2.3675495391350125, 114.39230625756204, 54.84375196092924, -0.0, -0.0],
        [11.868847924292282, 120.4678965884309, 57.65624964621793, -0.0, -0.0],
        [6.624446177521037, 126.1456590935264, 54.84375044653484, -0.0, -0.0],
        [9.85254975964493, 139.8070854957106, 56.24999964448676, -0.0, -0.0],
        [10.284527175032494, 149.50936934645668, 57.65624974825016, -0.0, -0.0],
        [58.633634895542144, 152.74703226226322, 39.374999323555016, -0.0, -0.0],
        [4.697009771612514, 143.54534575495455, 50.62500035351184, -0.0, -0.0],
        [8.739223964927803, 153.34156227954617, 53.528990504798344, -0.0, -0.0],
        [13.215579639909052, 153.46194700482943, 56.24999989276381, -0.0, -0.0],
        [35.125741719584425, 155.98690869749788, 74.53125022294324, -0.0, -0.0],
        [24.241351890014528, 157.62937775317255, 46.40625150340372, -0.0, -0.0],
        [18.161124683110756, 81.83346531088333, 333.5816655275555, -0.0, -0.0],
        [14.119870407166076, 81.72454607009684, 332.9447033765355, -0.0, -0.0],
        [9.106476144519206, 79.64886950327454, 336.093749983792, -0.0, -0.0],
        [9.175438738145829, 89.35318537114819, 330.4687496386661, -0.0, -0.0],
        [7.175311305543758, 89.29928152249676, 333.2812488125304, -0.0, -0.0],
        [17.18271530409055, 91.50937668932787, 333.281249739689, -0.0, -0.0],
        [13.148079549129832, 87.51982195330109, 333.47210714792664, -0.0, -0.0],
        [9.00367345558179, 85.46766826184691, 331.87499935742085, -0.0, -0.0],
        [11.180777220614587, 91.34762616568598, 336.0937499007258, -0.0, -0.0],
        [5.179245407263252, 91.18588626611778, 331.8749991482967, -0.0, -0.0],
        [11.450337146268097, 95.23559046496233, 333.2812498303779, -0.0, -0.0],
        [7.433751874506456, 95.12734785957713, 336.0937502957362, -0.0, -0.0],
        [3.8208447469418445, 96.97028993475566, 334.68750081043464, -0.0, -0.0],
        [10.68225901059121, 83.57241764071574, 338.90625002518703, -0.0, -0.0],
        [11.877602499687342, 75.84234920940848, 338.9062493960632, -0.0, -0.0],
        [16.140637032013714, 81.77900965371339, 337.4999999090718, -0.0, -0.0],
        [18.06254142500468, 76.009052783409, 338.6346440529167, -0.0, -0.0],
        [18.161124683110756, 81.83346531088333, 338.9062489929637, -0.0, -0.0],
        [13.449560754983963, 73.94406117392357, 337.61929356282656, -0.0, -0.0],
        [15.860724873649104, 77.89032718690052, 337.5000003023005, -0.0, -0.0],
        [19.950498765577194, 78.00055803807608, 338.9062492669124, -0.0, -0.0],
        [9.722901027948168, 77.72489512822938, 340.3125001332472, -0.0, -0.0],
        [17.61017292978873, 74.05620533778338, 337.5000008929808, -0.0, -0.0],
        [16.446428988822134, 72.0841448424426, 334.6874995786454, -0.0, -0.0],
        [14.460455758454842, 70.0898797223358, 337.5000007581206, -0.0, -0.0],
        [13.404246631068986, 64.23894693338787, 336.0937509878121, -0.0, -0.0],
    ]
    ...
    def test_pickle_value(self):
        ...
        return_old = oldfu.angle_diff_sym(
            angle1=self.angle1, angle2=self.angle2, simi=1
        )
    ...
    def test_angle2_bigger_than_angle1_printout_errorMsg(self):
        return_new = fu.angle_diff_sym(
            angle1=self.angle1, angle2=self.angle2 + [2], simi=1
        )
        return_old = oldfu.angle_diff_sym(
            angle1=self.angle1, angle2=self.angle2 + [2], simi=1
        )
...
class Test_align_diff_params(unittest.TestCase):
    ...
    def test_pickle_file(self):
        return_new = fu.align_diff_params(
            ali_params1=self.ali_params1, ali_params2=self.ali_params2
        )
        return_old = oldfu.align_diff_params(
            ali_params1=self.ali_params1, ali_params2=self.ali_params2
        )
        self.assertTrue(numpy_array_equal(return_new, return_old))
        self.assertTrue(
            numpy_array_equal(return_new, (359.99999999135014, 0.0, 0.0, 0))
        )
    ...
    def test_ali_params1_emptyList_printout_ErrorMsg(self):
        ...
        return_old = oldfu.align_diff_params(
            ali_params1=[], ali_params2=self.ali_params2
        )
        self.assertTrue(numpy_array_equal(return_new, return_old))
        self.assertTrue(numpy_array_equal(return_new, (0.0, 0.0, 0.0, 0)))
    ...
    def test_ali_params2_emptyList_printout_ErrorMsg(self):
        ...
        return_old = oldfu.align_diff_params(
            ali_params1=self.ali_params1, ali_params2=[]
        )
        self.assertTrue(numpy_array_equal(return_new, return_old))
        self.assertTrue(numpy_array_equal(return_new, (0.0, 0.0, 0.0, 0)))
...
class Test_multi_align_stability(unittest.TestCase):
    ...
    def test_pickle_value(self):
        return_new = fu.multi_align_stability(
            ali_params=self.ali_params,
            mir_stab_thld=self.mir_stab_thld,
            grp_err_thld=self.grp_err_thld,
            err_thld=self.err_thld,
            print_individual=False,
            d=self.d,
        )
        return_old = oldfu.multi_align_stability(
            ali_params=self.ali_params,
            mir_stab_thld=self.mir_stab_thld,
            grp_err_thld=self.grp_err_thld,
            err_thld=self.err_thld,
