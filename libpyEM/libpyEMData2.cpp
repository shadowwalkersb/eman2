...
BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(EMAN_EMData_calc_ccfx_overloads_1_6, EMAN::EMData::calc_ccfx, 1, 6)
...
// NOTE: important that read/write image functions are NOT made threadsafe (releasing GIL). HDF5 is not threadsafe!
	...
	.def("write_images", &EMAN::EMData::write_images, ("Write a set of images to file specified by 'filename'.\nWhich images are read is set by 'img_indices'.\nfilename The image file name."))
...
//	.def("symplane0_ctf", &EMAN::EMData::symplane0_ctf)
	...
	.def("ft2polar", &EMAN::EMData::ft2polar, return_value_policy< manage_new_object >(), args("ring_length", "nb", "ne"), "ft2polar extracts rings from nb to ne (including)\n")
	.def("ft2polargrid", &EMAN::EMData::ft2polargrid, return_value_policy< manage_new_object >(), args("ring_length", "nb", "ne", "grid"), "ft2polargrid extracts rings from nb to ne (including)\n")
	...
	.def("fouriergridrot_shift2d", &EMAN::EMData::fouriergridrot_shift2d, return_value_policy< manage_new_object >(), args("ang", "sx", "sy", "kb"), " ")
	.def("fourier_rotate_shift2d", &EMAN::EMData::fourier_rotate_shift2d, return_value_policy< manage_new_object >(), args("ang", "sx", "sy", "npad"), " ")
	.def("div_sinc", &EMAN::EMData::div_sinc, args("interpolate_method"), "divide real space volume by (0) sinc or (1) sinc^2")
	.def("extract_section", &EMAN::EMData::extract_section, return_value_policy< manage_new_object >(), args("tf", "interpolate_method"), "extract_section -- returns complex section (projection)")
	.def("extract_section2", &EMAN::EMData::extract_section2, return_value_policy< manage_new_object >(), args("tf", "interpolate_method"), "extract_section2 -- returns complex section (projection) from padded volume")
	.def("extract_rings", &EMAN::EMData::extract_rings, return_value_policy< manage_new_object >(), args("tf", "interpolate_method", "ring_length", "nb", "ne"), "extract_rings -- returns complex rings from a section (projection) of a padded volume")
...
//	.def("rotate_translate", (void (EMAN::EMData::*)(const EMAN::Transform3D&) )&EMAN::EMData::rotate_translate, args("t"), "Rotate then translate the image.\nDEPRECATED USE EMData::Transform\n \nt - The rotation and translation transformation to be done.")
	...
	.def("__truediv__", (EMAN::EMData* (*)(const EMAN::EMData&, const EMAN::EMData&) )&EMAN::operator/, return_value_policy< manage_new_object >() )
	...
	.def("__truediv__", (EMAN::EMData* (*)(const EMAN::EMData&, float) )&EMAN::operator/, return_value_policy< manage_new_object >() )
	...
	.def("__rtruediv__", (EMAN::EMData* (*)(const EMAN::EMData&, float) )&EMAN::rdiv, return_value_policy< manage_new_object >() )
