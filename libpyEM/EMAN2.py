...
class EMArgumentParser(argparse.ArgumentParser):
	...
	opts = {
		...
		'--path'       : {'type': str,   'default': 'None', 'help': 'Path to a folder where results should be stored. Creates a new folder if none specified (default = m2d_XX)', },
		'--sym'        : {'type': str,   'default': 'c1', 'help': 'model symmetry (using sym, if present, speeds thing up a lot), default='c1'', },
		'--threads'    : {'type': int,   'default': 4, 'help': 'Number of alignment threads to run in parallel on a single computer', },
		'--parallel'   : {'type': None,  'default': None, 'help': 'parallelism argument', },
		'--mask'       : {'type': int,   'default': -2, 'help': 'Mask radius', },
		'--apix'       : {'type': float, 'default': -1, 'help': 'Angstroms per pixel for all images', },
		'--input'      : {'type': str,   'default': 'None', 'help': 'The name of the input particle stack', },
		'--iter'       : {'type': int,   'default': 0, 'help': 'Iteration number within path. Default = start a new iteration', },
		'--shrink'     : {'type': int,   'default': 0, 'help': 'Shrink the images by an integer, uses math.meanshrink', },
		'--output'     : {'type': str,   'default': 'None', 'help': 'The name of the output class stack', },
		'--maxres'     : {'type': float, 'default': 0, 'help': 'The highest resolution to be fitted (Angstroms)', },
		'--align'      : {'type': str,   'default': 'rotate_translate_tree', 'help': 'This is the aligner used to align particles to the previous class average. Default is None.', },
		'--keep'       : {'type': float, 'default': 1, 'help': 'The fraction of particles to keep in each class.', },
		'--debug'      : {'type': None,  'default': False, 'help': 'debug mode', },
		'--preprocess' : {'type': str,   'default': 'None', 'help': 'preprocess maps before alignment', },
	}
