...
class SwarmPanel(object):
	...
	def get_widget(self):
		if self.widget == None:
			...
			self.view_template=QtWidgets.QPushButton( QtWidgets.QIcon(get_image_directory() + "pp_boxer_icon.png"),"View Template")
			...
			self.autobox=QtWidgets.QPushButton(QtWidgets.QIcon(get_image_directory() + "green_boxes.png"),"Autobox")
...
class GaussPanel(object):
	...
	def get_widget(self):
		if self.widget == None:
			...
			self.autobox=QtWidgets.QPushButton(QtWidgets.QIcon(get_image_directory() + "green_boxes.png"),"Run")
