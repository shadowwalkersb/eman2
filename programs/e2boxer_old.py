...
class GaussPanel(object):
	...
	def get_widget(self):
		if self.widget == None:
			...
			#self.ctf_f_stop = QtWidgets.QLineEdit(str(gbdb.setdefault('ctf_fstop',"0.500")))
			#hbl_fs.addWidget(self.ctf_f_stop)

			#vbl.addLayout(hbl_fs)
			#hbl_ctf = QtWidgets.QHBoxLayout()
			#self.estimate_ctf=QtWidgets.QPushButton("Estimate CTF")
			#hbl_ctf.addWidget(self.estimate_ctf)

			#self.inspect_button=QtWidgets.QPushButton("Inspect CTF")
