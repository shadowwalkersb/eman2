...
class TestEMUtils(unittest.TestCase):
    ...
    def test_get_image_ext_type(self):
        ...
        self.assertEqual(EMUtil.get_image_ext_type('mrc'), EMUtil.ImageType.IMAGE.MRC)
        self.assertEqual(EMUtil.get_image_ext_type('MRC'), EMUtil.ImageType.IMAGE.MRC)
        self.assertEqual(EMUtil.get_image_ext_type('tnf'), EMUtil.ImageType.IMAGE.MRC)
        self.assertEqual(EMUtil.get_image_ext_type('TNF'), EMUtil.ImageType.IMAGE.MRC)
        
        self.assertEqual(EMUtil.get_image_ext_type('dm3'), EMUtil.ImageType.IMAGE.DM3)
        self.assertEqual(EMUtil.get_image_ext_type('DM3'), EMUtil.ImageType.IMAGE.DM3)
        
        self.assertEqual(EMUtil.get_image_ext_type('dm4'), EMUtil.ImageType.IMAGE.DM4)
        self.assertEqual(EMUtil.get_image_ext_type('DM4'), EMUtil.ImageType.IMAGE.DM4)
        
        self.assertEqual(EMUtil.get_image_ext_type('spi'), EMUtil.ImageType.IMAGE.SPIDER)
        self.assertEqual(EMUtil.get_image_ext_type('SPI'), EMUtil.ImageType.IMAGE.SPIDER)
        self.assertEqual(EMUtil.get_image_ext_type('spider'), EMUtil.ImageType.IMAGE.SPIDER)
        self.assertEqual(EMUtil.get_image_ext_type('SPIDER'), EMUtil.ImageType.IMAGE.SPIDER)
        
        self.assertEqual(EMUtil.get_image_ext_type('spidersingle'), EMUtil.ImageType.IMAGE.SINGLE_SPIDER)
        self.assertEqual(EMUtil.get_image_ext_type('SPIDERSINGLE'), EMUtil.ImageType.IMAGE.SINGLE_SPIDER)
        self.assertEqual(EMUtil.get_image_ext_type('singlespider'), EMUtil.ImageType.IMAGE.SINGLE_SPIDER)
        self.assertEqual(EMUtil.get_image_ext_type('SINGLESPIDER'), EMUtil.ImageType.IMAGE.SINGLE_SPIDER)
        
        self.assertEqual(EMUtil.get_image_ext_type('img'), EMUtil.ImageType.IMAGE.IMAGIC)
        self.assertEqual(EMUtil.get_image_ext_type('IMG'), EMUtil.ImageType.IMAGE.IMAGIC)
        self.assertEqual(EMUtil.get_image_ext_type('hed'), EMUtil.ImageType.IMAGE.IMAGIC)
        self.assertEqual(EMUtil.get_image_ext_type('HED'), EMUtil.ImageType.IMAGE.IMAGIC)
        self.assertEqual(EMUtil.get_image_ext_type('imagic'), EMUtil.ImageType.IMAGE.IMAGIC)
        self.assertEqual(EMUtil.get_image_ext_type('IMAGIC'), EMUtil.ImageType.IMAGE.IMAGIC)
        
        self.assertEqual(EMUtil.get_image_ext_type('pgm'), EMUtil.ImageType.IMAGE.PGM)
        self.assertEqual(EMUtil.get_image_ext_type('PGM'), EMUtil.ImageType.IMAGE.PGM)
        
        self.assertEqual(EMUtil.get_image_ext_type('lst'), EMUtil.ImageType.IMAGE.LST)
        self.assertEqual(EMUtil.get_image_ext_type('LST'), EMUtil.ImageType.IMAGE.LST)
        
        self.assertEqual(EMUtil.get_image_ext_type('pif'), EMUtil.ImageType.IMAGE.PIF)
        self.assertEqual(EMUtil.get_image_ext_type('PIF'), EMUtil.ImageType.IMAGE.PIF)
        
        self.assertEqual(EMUtil.get_image_ext_type('png'), EMUtil.ImageType.IMAGE.PNG)
        self.assertEqual(EMUtil.get_image_ext_type('PNG'), EMUtil.ImageType.IMAGE.PNG)
        
        self.assertEqual(EMUtil.get_image_ext_type('h5'), EMUtil.ImageType.IMAGE.HDF)
        self.assertEqual(EMUtil.get_image_ext_type('H5'), EMUtil.ImageType.IMAGE.HDF)
        self.assertEqual(EMUtil.get_image_ext_type('hdf'), EMUtil.ImageType.IMAGE.HDF)
        self.assertEqual(EMUtil.get_image_ext_type('HDF'), EMUtil.ImageType.IMAGE.HDF)
        self.assertEqual(EMUtil.get_image_ext_type('hd5'), EMUtil.ImageType.IMAGE.HDF)
        self.assertEqual(EMUtil.get_image_ext_type('HD5'), EMUtil.ImageType.IMAGE.HDF)
        
        self.assertEqual(EMUtil.get_image_ext_type('tif'), EMUtil.ImageType.IMAGE.TIFF)
        self.assertEqual(EMUtil.get_image_ext_type('TIF'), EMUtil.ImageType.IMAGE.TIFF)
        self.assertEqual(EMUtil.get_image_ext_type('tiff'), EMUtil.ImageType.IMAGE.TIFF)
        self.assertEqual(EMUtil.get_image_ext_type('TIFF'), EMUtil.ImageType.IMAGE.TIFF)
        
        self.assertEqual(EMUtil.get_image_ext_type('vtk'), EMUtil.ImageType.IMAGE.VTK)
        self.assertEqual(EMUtil.get_image_ext_type('VTK'), EMUtil.ImageType.IMAGE.VTK)
        
        self.assertEqual(EMUtil.get_image_ext_type('hdr'), EMUtil.ImageType.IMAGE.SAL)
        self.assertEqual(EMUtil.get_image_ext_type('HDR'), EMUtil.ImageType.IMAGE.SAL)
        self.assertEqual(EMUtil.get_image_ext_type('sal'), EMUtil.ImageType.IMAGE.SAL)
        self.assertEqual(EMUtil.get_image_ext_type('SAL'), EMUtil.ImageType.IMAGE.SAL)
        
        self.assertEqual(EMUtil.get_image_ext_type('map'), EMUtil.ImageType.IMAGE.ICOS)
        self.assertEqual(EMUtil.get_image_ext_type('MAP'), EMUtil.ImageType.IMAGE.ICOS)
        self.assertEqual(EMUtil.get_image_ext_type('icos'), EMUtil.ImageType.IMAGE.ICOS)
        self.assertEqual(EMUtil.get_image_ext_type('ICOS'), EMUtil.ImageType.IMAGE.ICOS)
        
        self.assertEqual(EMUtil.get_image_ext_type('am'), EMUtil.ImageType.IMAGE.AMIRA)
        self.assertEqual(EMUtil.get_image_ext_type('AM'), EMUtil.ImageType.IMAGE.AMIRA)
        self.assertEqual(EMUtil.get_image_ext_type('amira'), EMUtil.ImageType.IMAGE.AMIRA)
        self.assertEqual(EMUtil.get_image_ext_type('AMIRA'), EMUtil.ImageType.IMAGE.AMIRA)
        
        self.assertEqual(EMUtil.get_image_ext_type('emim'), EMUtil.ImageType.IMAGE.EMIM)
        self.assertEqual(EMUtil.get_image_ext_type('EMIM'), EMUtil.ImageType.IMAGE.EMIM)
        
        self.assertEqual(EMUtil.get_image_ext_type('xplor'), EMUtil.ImageType.IMAGE.XPLOR)
        self.assertEqual(EMUtil.get_image_ext_type('XPLOR'), EMUtil.ImageType.IMAGE.XPLOR)
        
        self.assertEqual(EMUtil.get_image_ext_type('em'), EMUtil.ImageType.IMAGE.EM)
        self.assertEqual(EMUtil.get_image_ext_type('EM'), EMUtil.ImageType.IMAGE.EM)
        
        self.assertEqual(EMUtil.get_image_ext_type('dm2'), EMUtil.ImageType.IMAGE.GATAN2)
        self.assertEqual(EMUtil.get_image_ext_type('DM2'), EMUtil.ImageType.IMAGE.GATAN2)
        
        self.assertEqual(EMUtil.get_image_ext_type('v4l'), EMUtil.ImageType.IMAGE.V4L)
        self.assertEqual(EMUtil.get_image_ext_type('V4L'), EMUtil.ImageType.IMAGE.V4L)
        
        self.assertEqual(EMUtil.get_image_ext_type('jpg'), EMUtil.ImageType.IMAGE.JPEG)
        self.assertEqual(EMUtil.get_image_ext_type('JPG'), EMUtil.ImageType.IMAGE.JPEG)
        self.assertEqual(EMUtil.get_image_ext_type('jpeg'), EMUtil.ImageType.IMAGE.JPEG)
        self.assertEqual(EMUtil.get_image_ext_type('JPEG'), EMUtil.ImageType.IMAGE.JPEG)
        
        self.assertEqual(EMUtil.get_image_ext_type('xyz'), EMUtil.ImageType.IMAGE.UNKNOWN)
        
    def test_get_image_type(self):
        """test get_image_type function ....................."""
        e = test_image()
        e.write_image('mrcfile', 0, EMUtil.ImageType.IMAGE.MRC)
        self.assertEqual(EMUtil.get_image_type('mrcfile'), EMUtil.ImageType.IMAGE.MRC)
        testlib.safe_unlink('mrcfile')
        
        e2 = test_image()
        e2.write_image('hdffile', 0, EMUtil.ImageType.IMAGE.HDF)
        self.assertEqual(EMUtil.get_image_type('hdffile'), EMUtil.ImageType.IMAGE.HDF)
        testlib.safe_unlink('hdffile')
        
        #e.write_image('lstfile', 0, EMUtil.ImageType.IMAGE.LST)
        #self.assertEqual(EMUtil.get_image_type('lstfile'), EMUtil.ImageType.IMAGE.LST)
        #testlib.safe_unlink('lstfile')
        
        e3 = test_image()
        e3.write_image('spiderfile', 0, EMUtil.ImageType.IMAGE.SPIDER)
        self.assertEqual(EMUtil.get_image_type('spiderfile'), EMUtil.ImageType.IMAGE.SPIDER)
        testlib.safe_unlink('spiderfile')
        
        e3.write_image('sspiderfile', 0, EMUtil.ImageType.IMAGE.SINGLE_SPIDER)
        self.assertEqual(EMUtil.get_image_type('sspiderfile'), EMUtil.ImageType.IMAGE.SINGLE_SPIDER)
        testlib.safe_unlink('sspiderfile')
        
        #e.write_image('piffile', 0, EMUtil.ImageType.IMAGE.PIF)
        #self.assertEqual(EMUtil.get_image_type('piffile'), EMUtil.ImageType.IMAGE.PIF)
        #testlib.safe_unlink('piffile')
        
        platform = get_platform()
        if platform!='Windows' and platform!='win32':
            e4 = test_image()
            e4.write_image('pngfile', 0, EMUtil.ImageType.IMAGE.PNG)
            self.assertEqual(EMUtil.get_image_type('pngfile'), EMUtil.ImageType.IMAGE.PNG)
            testlib.safe_unlink('pngfile')
        
        e5 = test_image()
        e5.write_image('vtkfile', 0, EMUtil.ImageType.IMAGE.VTK)
        self.assertEqual(EMUtil.get_image_type('vtkfile'), EMUtil.ImageType.IMAGE.VTK)
        testlib.safe_unlink('vtkfile')
        
        e6 = test_image()
        e6.write_image('pgmfile', 0, EMUtil.ImageType.IMAGE.PGM)
        self.assertEqual(EMUtil.get_image_type('pgmfile'), EMUtil.ImageType.IMAGE.PGM)
        testlib.safe_unlink('pgmfile')
        
        e7 = test_image()
        e7.write_image('icosfile', 0, EMUtil.ImageType.IMAGE.ICOS)
        self.assertEqual(EMUtil.get_image_type('icosfile'), EMUtil.ImageType.IMAGE.ICOS)
        testlib.safe_unlink('icosfile')
        
        e8 = test_image()
        e8.write_image('xplorfile', 0, EMUtil.ImageType.IMAGE.XPLOR)
        self.assertEqual(EMUtil.get_image_type('xplorfile'), EMUtil.ImageType.IMAGE.XPLOR)
        testlib.safe_unlink('xplorfile')
        
        e9 = test_image()
        e9.write_image('emfile', 0, EMUtil.ImageType.IMAGE.EM)
        self.assertEqual(EMUtil.get_image_type('emfile'), EMUtil.ImageType.IMAGE.EM)
        testlib.safe_unlink('emfile')
        
        e10 = test_image()
        e10.write_image('imagicfile', 0, EMUtil.ImageType.IMAGE.IMAGIC)
        self.assertEqual(EMUtil.get_image_type('imagicfile.hed'), EMUtil.ImageType.IMAGE.IMAGIC)
    ...
    def test_get_image_count(self):
        ...
        g = test_image()
        g.write_image('test_image_count.spi', 0, EMUtil.ImageType.IMAGE.SPIDER)
        g.write_image('test_image_count.spi', 1, EMUtil.ImageType.IMAGE.SPIDER)
        g.write_image('test_image_count.spi', 2, EMUtil.ImageType.IMAGE.SPIDER)
    ...
    def test_get_imagetype_name(self):
        ...
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.V4L), 'V4L2')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.MRC), 'MRC')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.SPIDER), 'SPIDER')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.SINGLE_SPIDER), 'Single-SPIDER')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.IMAGIC), 'IMAGIC')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.PGM), 'PGM')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.LST), 'LST')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.PIF), 'PIF')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.PNG), 'PNG')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.HDF), 'HDF5')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.DM3), 'GatanDM3')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.DM4), 'GatanDM4')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.TIFF), 'TIFF')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.VTK), 'VTK')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.SAL), 'HDR')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.ICOS), 'ICOS_MAP')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.EMIM), 'EMIM')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.GATAN2), 'GatanDM2')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.JPEG), 'JPEG')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.AMIRA), 'AmiraMesh')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.XPLOR), 'XPLOR')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.EM), 'EM')
        self.assertEqual(EMUtil.get_imagetype_name(EMUtil.ImageType.IMAGE.UNKNOWN), 'unknown')
